<?php /* Smarty version 2.6.26, created on 2013-06-24 15:38:37
         compiled from cfields/cfieldsView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'cfields/cfieldsView.tpl', 10, false),array('modifier', 'replace', 'cfields/cfieldsView.tpl', 10, false),array('modifier', 'escape', 'cfields/cfieldsView.tpl', 49, false),array('function', 'config_load', 'cfields/cfieldsView.tpl', 11, false),array('function', 'lang_get', 'cfields/cfieldsView.tpl', 22, false),)), $this); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "inc_head.tpl", 'smarty_include_vars' => array('enableTableSorting' => 'yes')));
...
<?php echo $this->_tpl_vars['labels']['name']; ?>
</th>
  		<th><?php echo $this->_tpl_vars['tlImages']['sort_hint']; ?>
<?php echo $this->_tpl_vars['labels']['label']; ?>
</th>
  		<th><?php echo $this->_tpl_vars['tlImages']['sort_hint']; ?>
<?php echo $this->_tpl_vars['labels']['type']; ?>
</th>
  		<th class="<?php echo $this->_tpl_vars['noSortableColumnClass']; ?>
"><?php echo $this->_tpl_vars['labels']['enable_on_design']; ?>
</th>
  		<th class="<?php echo $this->_tpl_vars['noSortableColumnClass']; ?>
"><?php echo $this->_tpl_vars['labels']['show_on_exec']; ?>
</th>
  		<th class="<?php echo $this->_tpl_vars['noSortableColumnClass']; ?>
"><?php echo $this->_tpl_vars['labels']['enable_on_exec']; ?>
</th>
  		<th class="<?php echo $this->_tpl_vars['noSortableColumnClass']; ?>
"><?php echo $this->_tpl_vars['labels']['enable_on_testplan_design']; ?>
</th>
  		<th><?php echo $this->_tpl_vars['tlImages']['sort_hint']; ?>
<?php echo $this->_tpl_vars['labels']['available_on']; ?>
</th>
  	</tr>
