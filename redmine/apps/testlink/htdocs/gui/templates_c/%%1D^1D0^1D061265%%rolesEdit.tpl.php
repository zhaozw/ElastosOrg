<?php /* Smarty version 2.6.26, created on 2013-10-08 11:25:48
         compiled from usermanagement/rolesEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'usermanagement/rolesEdit.tpl', 18, false),array('function', 'config_load', 'usermanagement/rolesEdit.tpl', 56, false),array('modifier', 'escape', 'usermanagement/rolesEdit.tpl', 27, false),array('modifier', 'basename', 'usermanagement/rolesEdit.tpl', 55, false),array('modifier', 'replace', 'usermanagement/rolesEdit.tpl', 55, false),)), $this); ?>
...
"/>
    ...
    <tr><td>
         <input type="text" name="rolename" <?php echo $this->_tpl_vars['gui']->disabledAttr; ?>
...
<br />
          ...
          <td><fieldset class="x-fieldset x-form-label-left"><legend ><?php echo $this->_tpl_vars['labels']['th_issuetracker_rights']; ?>
</legend>
              <?php $_from = $this->_tpl_vars['gui']->rightsCfg->issuetracker_mgmt; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['id']):
?>
              <input class="tl-input" type="checkbox" name="grant[<?php echo $this->_tpl_vars['k']; ?>
]" <?php echo $this->_tpl_vars['gui']->checkboxStatus[$this->_tpl_vars['k']]; ?>
...
<br />
          ...
          <td><fieldset class="x-fieldset x-form-label-left"><legend ><?php echo $this->_tpl_vars['labels']['th_execution_rights']; ?>
</legend>
              <?php $_from = $this->_tpl_vars['gui']->rightsCfg->execution; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['id']):
?>
              <input class="tl-input" type="checkbox" name="grant[<?php echo $this->_tpl_vars['k']; ?>
]" <?php echo $this->_tpl_vars['gui']->checkboxStatus[$this->_tpl_vars['k']]; ?>
...
<br />
  ...
  <?php $this->assign('submitEnabled', '1'); ?>
  <?php if ($this->_tpl_vars['tlCfg']->demoMode): ?>
    <?php if ($this->_tpl_vars['gui']->operation == 'doUpdate'): ?>
      <?php $this->assign('submitEnabled', '0'); ?>
    <?php endif; ?>  
  <?php endif; ?>
  ...
  <?php if ($this->_tpl_vars['gui']->grants->role_mgmt == 'yes' && $this->_tpl_vars['gui']->role->dbID != @TL_ROLES_NO_RIGHTS): ?>
    ...
    <?php if ($this->_tpl_vars['submitEnabled']): ?>
      <?php if ($this->_tpl_vars['gui']->roleCanBeEdited): ?>
...
"
      ...
      <?php endif; ?>    
    <?php else: ?>
      <?php echo $this->_tpl_vars['labels']['demo_update_role_disabled']; ?>
<br>
    <?php endif; ?>
