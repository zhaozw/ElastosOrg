<?php /* Smarty version 2.6.26, created on 2013-06-27 14:33:14
         compiled from plan/tc_exec_assignment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'plan/tc_exec_assignment.tpl', 11, false),array('function', 'html_options', 'plan/tc_exec_assignment.tpl', 87, false),array('modifier', 'escape', 'plan/tc_exec_assignment.tpl', 25, false),)), $this); ?>
 ...
 ?>
	<div class="groupBtn">
		<div>
			...
			<?php endif; ?>
			<button onclick="cs_all_checkbox_in_div_with_platform('tc_exec_assignment_cb', '<?php echo $this->_tpl_vars['add_cb']; ?>
...
0px; border:1;">
        <br />
        	      <h3 class="testlink"><img class="clickable" src="<?php echo $this->_tpl_vars['tlImages']['toggle_all']; ?>
"
...
">
			      ...
			      <tr style="background-color:#059; font-weight:bold; color:white">
			          ...
			          <img class="clickable" src="<?php echo $this->_tpl_vars['tlImages']['toggle_all']; ?>
"
			               onclick='cs_all_checkbox_in_div("<?php echo $this->_tpl_vars['div_id']; ?>
","<?php echo $this->_tpl_vars['add_cb']; ?>
...
" />
            	    		<img class="clickable" src="<?php echo $this->_tpl_vars['tlImages']['exec_icon']; ?>
"
            	    		     onclick="javascript:openExecutionWindow(<?php echo $this->_tpl_vars['tcase']['id']; ?>
,<?php echo $this->_tpl_vars['tcase']['linked_version_id']; ?>
,<?php echo $this->_tpl_vars['gui']->build_id; ?>
,<?php echo $this->_tpl_vars['gui']->tplan_id; ?>
,<?php echo $this->_tpl_vars['platform_id']; ?>
);"
            	    		     title="<?php echo $this->_tpl_vars['labels']['execution']; ?>
" />
