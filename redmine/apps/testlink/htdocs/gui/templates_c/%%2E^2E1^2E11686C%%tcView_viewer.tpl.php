<?php /* Smarty version 2.6.26, created on 2013-06-24 16:01:18
         compiled from testcases/tcView_viewer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/tcView_viewer.tpl', 8, false),array('function', 'html_options', 'testcases/tcView_viewer.tpl', 356, false),array('modifier', 'escape', 'testcases/tcView_viewer.tpl', 48, false),)), $this); ?>
<?php echo lang_get_smarty(array('var' => 'tcView_viewer_labels','s' => "requirement_spec,Requirements,tcversion_is_inactive_msg,
             ...
             requirement,btn_show_exec_history,btn_resequence_steps,link_unlink_requirements"), $this);?>
...
<?php $this->assign('execFeatureAction', "lib/general/frmWorkArea.php?feature=executeTest"); ?>
...
<?php $this->assign('warning_delete_msg', ""); ?>
...
<?php if ($this->_tpl_vars['args_can_do']->edit == 'yes'): ?>
  ...
  <?php $this->assign('delete_enabled', 0); ?>
  ...
  <?php echo lang_get_smarty(array('s' => 'system_blocks_delete_executed_tc','var' => 'warning_delete_msg'), $this);?>
  ...
  <?php if ($this->_tpl_vars['args_status_quo'] == null || $this->_tpl_vars['args_status_quo'][$this->_tpl_vars['args_testcase']['id']]['executed'] == null): ?>
      ...
      <?php $this->assign('delete_enabled', 1); ?>
      <?php $this->assign('warning_edit_msg', ""); ?>
      <?php $this->assign('warning_delete_msg', ""); ?>
  <?php else: ?> 
    ...
    <?php if (isset ( $this->_tpl_vars['args_tcase_cfg'] )): ?>
      <?php if ($this->_tpl_vars['args_tcase_cfg']->can_delete_executed == 1): ?>
        <?php $this->assign('delete_enabled', 1); ?> 
        <?php $this->assign('has_been_executed', 1); ?> 
        <?php $this->assign('warning_delete_msg', ""); ?>
      <?php else: ?>
        <?php if (( $this->_tpl_vars['args_can_do']->delete_testcase == 'yes' && $this->_tpl_vars['args_can_delete_testcase'] == 'yes' ) || ( $this->_tpl_vars['args_can_do']->delete_version == 'yes' && $this->_tpl_vars['args_can_delete_version'] == 'yes' )): ?>
          <?php echo lang_get_smarty(array('s' => 'system_blocks_delete_executed_tc','var' => 'warning_delete_msg'), $this);?>
...
" />
    <?php endif; ?>
        ...
        <?php if ($this->_tpl_vars['delete_enabled'] && $this->_tpl_vars['args_can_do']->delete_testcase == 'yes' && $this->_tpl_vars['args_can_delete_testcase'] == 'yes'): ?>
...
" />
    ...
    <?php if ($this->_tpl_vars['edit_enabled']): ?>
        <input type="hidden" name="containerID" value="<?php echo $this->_tpl_vars['args_testcase']['testsuite_id']; ?>
" />
        <input type="submit" name="new_tc" title="<?php echo $this->_tpl_vars['tcView_viewer_labels']['hint_new_sibling']; ?>
"
               onclick="doAction.value='create';<?php echo $this->_tpl_vars['gui']->submitCode; ?>
" value="<?php echo $this->_tpl_vars['tcView_viewer_labels']['btn_new_sibling']; ?>
" />
    <?php endif; ?>
...
" />
    <input type="hidden" name="tcversion_id" value="<?php echo $this->_tpl_vars['args_testcase']['id']; ?>
" />
    <input type="submit" name="export_tc" value="<?php echo $this->_tpl_vars['tcView_viewer_labels']['btn_export']; ?>
" />
  </form>
  </span>
  ...
  <form style="display: inline;" id="tcprint" name="tcprint" method="post" action="" >
    <input type="button" name="tcPrinterFriendly" value="<?php echo $this->_tpl_vars['tcView_viewer_labels']['btn_print_view']; ?>
" 
...
');"/>
    ...
    <input type="hidden" name="testcase_id" id="versionControls_testcase_id" value="<?php echo $this->_tpl_vars['args_testcase']['testcase_id']; ?>
" />
    <input type="hidden" name="tcversion_id" value="<?php echo $this->_tpl_vars['args_testcase']['id']; ?>
" />
    <input type="hidden" name="has_been_executed" value="<?php echo $this->_tpl_vars['has_been_executed']; ?>
...
" />
    ...
    <?php if ($this->_tpl_vars['args_can_do']->create_new_version == 'yes'): ?>
      <input type="submit" name="do_create_new_version" title="<?php echo $this->_tpl_vars['tcView_viewer_labels']['hint_new_version']; ?>
" 
             value="<?php echo $this->_tpl_vars['tcView_viewer_labels']['btn_new_version']; ?>
" />
    <?php endif; ?>

    <?php if ($this->_tpl_vars['delete_enabled'] && $this->_tpl_vars['args_can_do']->delete_version == 'yes' && $this->_tpl_vars['args_can_delete_version'] == 'yes'): ?>
...
" />
  ...
  <span>
    <input type="button" onclick="javascript:openExecHistoryWindow(<?php echo $this->_tpl_vars['args_testcase']['testcase_id']; ?>
);"
           value="<?php echo $this->_tpl_vars['tcView_viewer_labels']['btn_show_exec_history']; ?>
" />
  </span>
  ...
  <?php endif; ?>
   <?php if ($this->_tpl_vars['warning_edit_msg'] != ""): ?>
       <div class="messages" align="center">
         <?php echo ((is_array($_tmp=$this->_tpl_vars['warning_edit_msg'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br>
       </div>
   <?php endif; ?>
   <?php if ($this->_tpl_vars['warning_delete_msg'] != ""): ?>
       <div class="messages" align="center">
         <?php echo ((is_array($_tmp=$this->_tpl_vars['warning_delete_msg'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<br>
       </div>
   <?php endif; ?>
...
" />
  ...
  <?php if ($this->_tpl_vars['args_testcase']['steps'] != ''): ?>
    <input type="submit" name="resequence_steps" id="resequence_steps" 
            onclick="doAction.value='doResequenceSteps';<?php echo $this->_tpl_vars['gui']->submitCode; ?>
" 
            value="<?php echo $this->_tpl_vars['tcView_viewer_labels']['btn_resequence_steps']; ?>
" />
  <?php endif; ?>
...
" />
 ...
 <?php echo @TITLE_SEP; ?>
    ...
    <select name="importance" onchange="importanceForm.submit()">
          <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['gsmarty_option_importance'],'selected' => $this->_tpl_vars['args_testcase']['importance']), $this);?>
...
?>
  ...
  <?php if ($this->_tpl_vars['gui']->requirementsEnabled == TRUE && ( $this->_tpl_vars['gui']->view_req_rights == 'yes' || $this->_tpl_vars['gui']->requirement_mgmt )): ?>
  <div <?php echo $this->_tpl_vars['addInfoDivStyle']; ?>
>
    <table cellpadding="0" cellspacing="0" style="font-size:100%;">
             <tr>
...
"
              ...
              <?php if ($this->_tpl_vars['gui']->requirement_mgmt): ?>
                <img class="clickable" src="<?php echo $this->_tpl_vars['tlImages']['item_link']; ?>
"
                     onclick="javascript:openReqWindow(<?php echo $this->_tpl_vars['args_testcase']['testcase_id']; ?>
);"
                     title="<?php echo $this->_tpl_vars['tcView_viewer_labels']['link_unlink_requirements']; ?>
" />
              <?php endif; ?>
              : &nbsp;</span>
             </td>
...
"
                     onclick="javascript:openLinkedReqWindow(<?php echo $this->_tpl_vars['args_reqs'][$this->_sections['item']['index']]['id']; ?>
);"
                     title="<?php echo $this->_tpl_vars['tcView_viewer_labels']['requirement']; ?>
" />
                <?php echo $this->_tpl_vars['gsmarty_gui']->role_separator_open; ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['args_reqs'][$this->_sections['item']['index']]['req_spec_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php echo $this->_tpl_vars['tcView_viewer_labels']['test_plan']; ?>
    ...
    <?php if ($this->_tpl_vars['gui']->platforms != null): ?>
      <th><?php echo $this->_tpl_vars['tlImages']['sort_hint']; ?>
...
?>
          ...
          <td><?php echo ((is_array($_tmp=$this->_tpl_vars['version_info']['tplan_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
              ...
              <a href="<?php echo $this->_tpl_vars['execFeatureAction']; ?>
" target="_parent" ><img class="clickable" src="<?php echo $this->_tpl_vars['tlImages']['execute']; ?>
" 
                             title="<?php echo $this->_tpl_vars['tcView_viewer_labels']['goto_execute']; ?>
" /></a>
          </td>
          <?php if ($this->_tpl_vars['gui']->platforms != null): ?>
            <td>
