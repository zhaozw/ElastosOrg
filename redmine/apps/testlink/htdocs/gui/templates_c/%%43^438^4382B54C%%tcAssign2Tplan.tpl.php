<?php /* Smarty version 2.6.26, created on 2013-09-09 17:36:49
         compiled from testcases/tcAssign2Tplan.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/tcAssign2Tplan.tpl', 10, false),array('modifier', 'escape', 'testcases/tcAssign2Tplan.tpl', 21, false),)), $this); ?>
...
/history_small.png"
      onclick="javascript:openExecHistoryWindow(<?php echo $this->_tpl_vars['gui']->tcase_id; ?>
);"
      title="<?php echo $this->_tpl_vars['labels']['execution_history']; ?>
" />
<img class="clickable" src="<?php echo @TL_THEME_IMG_DIR; ?>
/edit_icon.png"
     onclick="javascript:openTCaseWindow(<?php echo $this->_tpl_vars['gui']->tcase_id; ?>
);"
