<?php /* Smarty version 2.6.26, created on 2013-06-26 16:14:37
         compiled from results/printDocOptions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'results/printDocOptions.tpl', 5, false),array('function', 'html_options', 'results/printDocOptions.tpl', 76, false),array('modifier', 'escape', 'results/printDocOptions.tpl', 21, false),)), $this); ?>
...
$this->_sections['number']['loop'] = is_array($_loop=$this->_tpl_vars['gui']->outputOptions) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
    <tr>
      <td><?php echo $this->_tpl_vars['gui']->outputOptions[$this->_sections['number']['index']]['description']; ?>
</td>
      <td>
        <input type="checkbox" name="<?php echo $this->_tpl_vars['gui']->outputOptions[$this->_sections['number']['index']]['value']; ?>
" id="cb<?php echo $this->_tpl_vars['gui']->outputOptions[$this->_sections['number']['index']]['value']; ?>
"
        <?php if ($this->_tpl_vars['gui']->outputOptions[$this->_sections['number']['index']]['checked'] == 'y'): ?>checked="checked"<?php endif; ?>/>
      </td>
    </tr>
    <?php endfor; endif; ?>
    <tr>
