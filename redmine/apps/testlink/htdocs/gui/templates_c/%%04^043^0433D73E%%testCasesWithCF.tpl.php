<?php /* Smarty version 2.6.26, created on 2013-07-25 12:44:14
         compiled from results/testCasesWithCF.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'results/testCasesWithCF.tpl', 13, false),array('modifier', 'escape', 'results/testCasesWithCF.tpl', 31, false),array('modifier', 'date_format', 'results/testCasesWithCF.tpl', 44, false),)), $this); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'no_uncovered_testcases,testproject_has_no_reqspec,
             ...
             test_case,build,th_owner,date,status,info_testCasesWithCF'), $this);?>
...
?>
	...
	<?php endforeach; endif; unset($_from); ?>
	<br />
	<p class="italic"><?php echo $this->_tpl_vars['labels']['info_testCasesWithCF']; ?>
</p>
	<br />
