<?php /* Smarty version 2.6.26, created on 2013-06-27 17:18:28
...
" />
	...
	<title>ElastosOrg - TestLink <?php echo ((is_array($_tmp=$this->_tpl_vars['tlVersion'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</title>
	<meta name="description" content="TestLink - <?php echo ((is_array($_tmp=@$this->_tpl_vars['gui']->title)) ? $this->_run_mod_handler('default', true, $_tmp, 'Main page') : smarty_modifier_default($_tmp, 'Main page')); ?>
" />
...
<frameset rows="70,*" frameborder="0" framespacing="0">
	<frame src="<?php echo $this->_tpl_vars['gui']->titleframe; ?>
" name="titlebar" scrolling="no" noresize="noresize" />
	<frame src="<?php echo $this->_tpl_vars['gui']->mainframe; ?>
