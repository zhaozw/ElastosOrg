<?php /* Smarty version 2.6.26, created on 2013-06-26 16:40:53
         compiled from execute/inc_exec_show_tc_exec.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'execute/inc_exec_show_tc_exec.tpl', 21, false),array('function', 'localize_timestamp', 'execute/inc_exec_show_tc_exec.tpl', 134, false),array('function', 'localize_tc_status', 'execute/inc_exec_show_tc_exec.tpl', 149, false),array('function', 'cycle', 'execute/inc_exec_show_tc_exec.tpl', 216, false),array('modifier', 'escape', 'execute/inc_exec_show_tc_exec.tpl', 82, false),array('modifier', 'replace', 'execute/inc_exec_show_tc_exec.tpl', 142, false),)), $this); ?>
...
' />
    ...
    <?php $this->assign('container_title', ($this->_tpl_vars['container_title']).($this->_tpl_vars['title_sep']).($this->_tpl_vars['ts_name'])); ?>
		...
		<?php $this->assign('can_delete_exec', 0); ?>
	<?php $this->assign('can_edit_exec_notes', $this->_tpl_vars['gui']->grants->edit_exec_notes); ?>
	<?php $this->assign('can_manage_attachments', $this->_tpl_vars['gsmarty_attachments']->enabled); ?>
	<?php if ($this->_tpl_vars['tc_exec']['can_be_executed']): ?>
		<?php if ($this->_tpl_vars['gui']->grants->delete_execution): ?>
			<?php $this->assign('can_delete_exec', 1); ?>
		<?php endif; ?>
	<?php else: ?>
		<?php $this->assign('can_edit_exec_notes', 0); ?>
		<?php $this->assign('can_manage_attachments', 0); ?>
	<?php endif; ?>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['tc_exec']['assigned_user'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 	...
 	<?php if ($this->_tpl_vars['cfg']->exec_cfg->show_last_exec_any_build): ?>
   	...
   	<?php $this->assign('abs_last_exec', $this->_tpl_vars['gui']->map_last_exec_any_build[$this->_tpl_vars['tcversion_id']]); ?>
 		...
 		<?php $this->assign('show_current_build', 1); ?>
 		 		...
 		 		<?php if ($this->_tpl_vars['my_build_name'] == ''): ?>
 ...
 <?php echo $this->_tpl_vars['exec_build_title']; ?>
  		...
  		<?php endif; ?>
    		...
    		<?php if ($this->_tpl_vars['gui']->issueTrackerIntegrationOn): ?>
		  <p/>
			<a style="font-weight:normal" target="_blank" href="<?php echo $this->_tpl_vars['gui']->createIssueURL; ?>
">
			<?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->accessToIssueTracker)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>
		<?php endif; ?>
...
<?php echo $this->_tpl_vars['title_sep']; ?>
 ...
 <?php echo translate_tc_status_smarty(array('s' => $this->_tpl_vars['status_code']), $this);?>
	 ...
	 <?php if ($this->_tpl_vars['drawNotRun']): ?>
 ...
 <?php echo $this->_tpl_vars['labels']['exec_current_build']; ?>
  			    ...
  			    <?php echo $this->_tpl_vars['title_sep_type3']; ?>
 <?php echo $this->_tpl_vars['build_title']; ?>
 <?php echo $this->_tpl_vars['title_sep']; ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['gui']->build_name)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
		  ...
		  <table cellspacing="0" class="exec_history">
			 <tr>
				...
				<th style="text-align:center"><?php echo $this->_tpl_vars['labels']['testcaseversion']; ?>
								...
								<?php if ($this->_tpl_vars['attachment_model']->show_upload_column && $this->_tpl_vars['can_manage_attachments']): ?>
        ...
        <?php endif; ?>
				...
				<?php if ($this->_tpl_vars['can_delete_exec']): ?>
...
">
  			  <td>
            			  <?php if ($this->_tpl_vars['can_edit_exec_notes'] && $this->_tpl_vars['tc_old_exec']['build_is_open']): ?>
  		      <img src="<?php echo @TL_THEME_IMG_DIR; ?>
...
,<?php echo $this->_tpl_vars['gui']->tproject_id; ?>
  		      ...
  		      <?php else: ?>
  		         <?php if ($this->_tpl_vars['can_edit_exec_notes']): ?>
  		            <img src="<?php echo @TL_THEME_IMG_DIR; ?>
...
">
    			...
    			<?php if ($this->_tpl_vars['gui']->issueTrackerIntegrationOn): ?>
       		  <td align="center">
       		  <?php if ($this->_tpl_vars['tc_old_exec']['build_is_open']): ?>
       		    <a href="javascript:open_bug_add_window(<?php echo $this->_tpl_vars['gui']->tproject_id; ?>
,<?php echo $this->_tpl_vars['tc_old_exec']['id']; ?>
,<?php echo $this->_tpl_vars['tc_old_exec']['execution_id']; ?>
,'link')">
       		    <img src="<?php echo $this->_tpl_vars['tlImages']['bug_link_tl_to_bts']; ?>
" title="<?php echo $this->_tpl_vars['labels']['bug_link_tl_to_bts']; ?>
" style="border:none" /></a>
       		    &nbsp;&nbsp;
              <?php if ($this->_tpl_vars['gui']->tlCanCreateIssue): ?>
       		  	  <a href="javascript:open_bug_add_window(<?php echo $this->_tpl_vars['gui']->tproject_id; ?>
,<?php echo $this->_tpl_vars['tc_old_exec']['id']; ?>
,<?php echo $this->_tpl_vars['tc_old_exec']['execution_id']; ?>
,'create')">
      			    <img src="<?php echo $this->_tpl_vars['tlImages']['bug_create_into_bts']; ?>
" title="<?php echo $this->_tpl_vars['labels']['bug_create_into_bts']; ?>
" style="border:none" /></a>
              <?php endif; ?>
       		  <?php else: ?>
       		    <img src="<?php echo $this->_tpl_vars['tlImages']['bug_link_tl_to_bts_disabled']; ?>
" title="<?php echo $this->_tpl_vars['labels']['bug_link_tl_to_bts']; ?>
" style="border:none" /></a>
       		    &nbsp;&nbsp;
              <?php if ($this->_tpl_vars['gui']->tlCanCreateIssue): ?>
       		  	  <img src="<?php echo $this->_tpl_vars['tlImages']['bug_create_into_bts_disabled']; ?>
" title="<?php echo $this->_tpl_vars['labels']['bug_create_into_bts']; ?>
" style="border:none" /></a>
              <?php endif; ?>
            <?php endif; ?> 
          ...
          <?php endif; ?>
				    			    			...
				    			    			<?php if ($this->_tpl_vars['can_delete_exec'] && $this->_tpl_vars['tc_old_exec']['build_is_open']): ?>
	       		  	<td align="center">
    	         	<a href="javascript:confirm_and_submit(msg,'execSetResults','exec_to_delete',
             	                                       <?php echo $this->_tpl_vars['tc_old_exec']['execution_id']; ?>
,'do_delete',1);">
      			    <img src="<?php echo $this->_tpl_vars['tlImages']['delete']; ?>
" title="<?php echo $this->_tpl_vars['labels']['img_title_delete_execution']; ?>
"
      			         style="border:none" /></a>
      			 </td>
      			<?php else: ?>
      				<?php if ($this->_tpl_vars['can_delete_exec']): ?>
      					<td align="center">
      						<img src="<?php echo $this->_tpl_vars['tlImages']['delete_disabled']; ?>
" title="<?php echo $this->_tpl_vars['labels']['closed_build']; ?>
">
      					</td>
      				<?php endif; ?>
          		<?php endif; ?>
       		...
       		<td class="icon_cell" align="center">
       		  <?php if ($this->_tpl_vars['tc_old_exec']['execution_run_type'] == @TESTCASE_EXECUTION_TYPE_MANUAL): ?>
      		    <img src="<?php echo $this->_tpl_vars['tlImages']['testcase_execution_type_manual']; ?>
" title="<?php echo $this->_tpl_vars['labels']['execution_type_manual']; ?>
"
      		            style="border:none" />
       		  <?php else: ?>
      		    <img src="<?php echo $this->_tpl_vars['tlImages']['testcase_execution_type_automatic']; ?>
" title="<?php echo $this->_tpl_vars['labels']['execution_type_auto']; ?>
"
      		            style="border:none" />
       		  <?php endif; ?>
          </td>
