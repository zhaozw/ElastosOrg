<?php /* Smarty version 2.6.26, created on 2013-06-28 10:36:44
         compiled from firstLogin.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'firstLogin.tpl', 9, false),array('function', 'config_load', 'firstLogin.tpl', 26, false),array('modifier', 'escape', 'firstLogin.tpl', 36, false),)), $this); ?>
...
<br />
	<input type="text" name="firstName" size="<?php echo $this->_config[0]['vars']['NAMES_SIZE']; ?>
...
<br />
	<input type="text" name="lastName" size="<?php echo $this->_config[0]['vars']['NAMES_SIZE']; ?>
" maxlength="<?php echo $this->_config[0]['vars']['NAMES_SIZE']; ?>
" 
