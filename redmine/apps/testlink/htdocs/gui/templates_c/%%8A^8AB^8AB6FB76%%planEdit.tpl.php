<?php /* Smarty version 2.6.26, created on 2013-06-26 16:27:42
         compiled from plan/planEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'plan/planEdit.tpl', 9, false),array('function', 'config_load', 'plan/planEdit.tpl', 85, false),array('modifier', 'escape', 'plan/planEdit.tpl', 22, false),array('modifier', 'basename', 'plan/planEdit.tpl', 84, false),array('modifier', 'replace', 'plan/planEdit.tpl', 84, false),array('modifier', 'dirname', 'plan/planEdit.tpl', 138, false),)), $this); ?>
...
<?php $this->assign('planID', $this->_tpl_vars['gui']->tplan_id); ?>
...
<?php if ($this->_tpl_vars['gui']->grants->testplan_create == 'yes'): ?>
<?php $this->assign('downloadOnly', false); ?>
<?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "inc_attachments.tpl", 'smarty_include_vars' => array('attach_id' => $this->_tpl_vars['planID'],'attach_tableName' => $this->_tpl_vars['gui']->attachmentTableName,'attach_attachmentInfos' => $this->_tpl_vars['gui']->attachments[$this->_tpl_vars['planID']],'attach_downloadOnly' => $this->_tpl_vars['downloadOnly'],'attach_loadOnCancelURL' => $this->_tpl_vars['loadOnCancelURL'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
