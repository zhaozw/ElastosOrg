<?php /* Smarty version 2.6.26, created on 2013-06-24 15:24:55
         compiled from testcases/containerView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'testcases/containerView.tpl', 11, false),array('modifier', 'escape', 'testcases/containerView.tpl', 46, false),)), $this); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'th_product_name,edit_testproject_basic_data,th_notes,test_suite,details,none,
             ...
             btn_new_testsuite, btn_reorder,btn_execute_automatic_testcases,
	           ...
	           testsuite_operations, testcase_operations,btn_create_from_issue_xml'), $this);?>
...
<?php $this->assign('tcMantisXMLAction', "lib/testcases/tcCreateFromIssueMantisXML.php?containerID=".($this->_tpl_vars['container_id'])); ?>
<?php $this->assign('createTCFromIssueMantisXMLAction', ($this->_tpl_vars['basehref']).($this->_tpl_vars['tcMantisXMLAction'])); ?>
...
<div class="workBack">
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "inc_update.tpl", 'smarty_include_vars' => array('result' => $this->_tpl_vars['gui']->sqlResult,'item' => $this->_tpl_vars['gui']->level,'name' => $this->_tpl_vars['gui']->moddedItem['name'],'refresh' => $this->_tpl_vars['gui']->refreshTree,'user_feedback' => $this->_tpl_vars['gui']->user_feedback)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
" />
			...
			<input type="submit" name="testcases_table_view" value="<?php echo $this->_tpl_vars['labels']['btn_testcases_table_view']; ?>
"
			       title="<?php echo $this->_tpl_vars['labels']['btn_testcases_table_view']; ?>
" />
...
" />
      <input type="button" onclick="location='<?php echo $this->_tpl_vars['createTCFromIssueMantisXMLAction']; ?>
'" value="<?php echo $this->_tpl_vars['labels']['btn_create_from_issue_xml']; ?>
" />
		</form>
