<?php /* Smarty version 2.6.26, created on 2013-06-27 11:16:25
         compiled from usermanagement/userInfo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'usermanagement/userInfo.tpl', 11, false),array('function', 'lang_get', 'usermanagement/userInfo.tpl', 13, false),array('function', 'html_options', 'usermanagement/userInfo.tpl', 169, false),array('function', 'localize_timestamp', 'usermanagement/userInfo.tpl', 238, false),array('modifier', 'escape', 'usermanagement/userInfo.tpl', 33, false),)), $this); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'title_account_settings,warning_empty_pwd,warning_different_pwd,never_logged,
             ...
             demo_update_user_disabled'), $this);?>
...
"	onsubmit="return validatePersonalData(this)">
	...
	<table class="common" width="50%">
		<tr>
			<th width="20%"><?php echo $this->_tpl_vars['labels']['th_login']; ?>
</th>
 ...
 ?>
		...
		<tr>
			...
			<td>
				<script type="text/javascript">
					js_locale = new Array();
					<?php $_from = $this->_tpl_vars['optLocale']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['locale'] => $this->_tpl_vars['value']):
?>
						js_locale['<?php echo $this->_tpl_vars['locale']; ?>
'] = "<?php echo lang_get_smarty(array('s' => 'last_update','locale' => $this->_tpl_vars['locale']), $this);?>
";
				...
				<span id="last_update"><?php echo lang_get_smarty(array('s' => 'last_update'), $this);?>
</span>
			</td>
		</tr>
	</table>
	<div class="groupBtn">
		<?php if ($this->_tpl_vars['tlCfg']->demoMode): ?>
			<?php echo $this->_tpl_vars['labels']['demo_update_user_disabled']; ?>
