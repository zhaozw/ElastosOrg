<?php /* Smarty version 2.6.26, created on 2013-06-24 15:24:05
         compiled from inc_filter_panel.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'inc_filter_panel.tpl', 19, false),array('function', 'config_load', 'inc_filter_panel.tpl', 31, false),array('function', 'html_options', 'inc_filter_panel.tpl', 89, false),array('function', 'html_radios', 'inc_filter_panel.tpl', 210, false),)), $this); ?>
	...
	<div id="settings_panel">
		...
		<div id="settings" class="x-panel-body exec_additional_info" "style="padding-top: 3px;">
			...
			<?php if ($this->_tpl_vars['control']->settings['setting_build']): ?>
				<tr>
					<td><?php echo $this->_tpl_vars['control']->settings['setting_build']['label']; ?>
</td>
					<td>
...
">
		...
		<?php endif; ?>
                ...
                <?php if (isset ( $this->_tpl_vars['control']->filters['filter_active_inactive'] ) && $this->_tpl_vars['control']->filters['filter_active_inactive']): ?>
            <tr>
                <td><?php echo $this->_tpl_vars['labels']['filter_active_inactive']; ?>
</td>
                <td>
                    <select name="filter_active_inactive">
                        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['control']->filters['filter_active_inactive']['items'],'selected' => $this->_tpl_vars['control']->filters['filter_active_inactive']['selected']), $this);?>
        ...
        <?php endif; ?>
                ...
                <?php if ($this->_tpl_vars['control']->filters['filter_importance']): ?>
            <tr>
                <td><?php echo $this->_tpl_vars['labels']['importance']; ?>
</td>
                <td>
                    <select name="filter_importance">
                                                <option value=""><?php echo $this->_tpl_vars['control']->option_strings['any']; ?>
</option>
                        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['gsmarty_option_importance'],'selected' => $this->_tpl_vars['control']->filters['filter_importance']['selected']), $this);?>
		...
		<?php if ($this->_tpl_vars['control']->filters['filter_priority']): ?>
			<tr>
				<td><?php echo $this->_tpl_vars['labels']['priority']; ?>
</td>
				<td>
...
');">
		...
		<tr><td>&nbsp;</td></tr> 
	   		<tr>
				<td><?php echo $this->_tpl_vars['labels']['filter_result']; ?>
</td>
				<td>
...
">
			...
			<tr>
				<td><?php echo $this->_tpl_vars['labels']['filter_on']; ?>
</td>
				<td>
			...
			<tr id="filter_result_build_row">
				<td><?php echo $this->_tpl_vars['labels']['build']; ?>
</td>
