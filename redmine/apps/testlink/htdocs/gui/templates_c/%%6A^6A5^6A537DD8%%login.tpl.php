...
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'login.tpl', 6, false),array('function', 'config_load', 'login.tpl', 7, false),array('modifier', 'escape', 'login.tpl', 32, false),)), $this); ?>
	 	      ...
	 	      <form method="get" action="third_party/php-openid/examples/consumer/try_auth.php">
			  		          ElastosID:
							  				          <input type="hidden" name="action" value="verify" />
													  						          <input type="text" name="openid_identifier" <?php echo 'value="'.$_COOKIE['ElastosID'].'"'?> style="width:70%;"/>
