<?php /* Smarty version 2.6.26, created on 2013-06-24 15:41:58
         compiled from platforms/platformsView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'platforms/platformsView.tpl', 15, false),array('function', 'config_load', 'platforms/platformsView.tpl', 40, false),array('modifier', 'basename', 'platforms/platformsView.tpl', 39, false),array('modifier', 'replace', 'platforms/platformsView.tpl', 39, false),array('modifier', 'escape', 'platforms/platformsView.tpl', 61, false),array('modifier', 'strip_tags', 'platforms/platformsView.tpl', 67, false),array('modifier', 'strip', 'platforms/platformsView.tpl', 67, false),array('modifier', 'truncate', 'platforms/platformsView.tpl', 67, false),)), $this); ?>
...
">
				...
				<?php endif; ?>
						...
						<td><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['gui']->platforms[$this->_sections['platform']['index']]['notes'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, $this->_config[0]['vars']['PLATFORM_NOTES_TRUNCATE_LEN']) : smarty_modifier_truncate($_tmp, $this->_config[0]['vars']['PLATFORM_NOTES_TRUNCATE_LEN'])); ?>
</td>
