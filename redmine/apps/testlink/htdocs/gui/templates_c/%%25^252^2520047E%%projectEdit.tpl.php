<?php /* Smarty version 2.6.26, created on 2013-06-24 15:01:02
         compiled from project/projectEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'project/projectEdit.tpl', 12, false),array('modifier', 'replace', 'project/projectEdit.tpl', 12, false),array('modifier', 'escape', 'project/projectEdit.tpl', 37, false),array('function', 'config_load', 'project/projectEdit.tpl', 13, false),array('function', 'lang_get', 'project/projectEdit.tpl', 19, false),)), $this); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'show_event_history,th_active,cancel,info_failed_loc_prod,invalid_query,
  ...
  testproject_reqmgr_integration,reqmgrsystem,no_rms_defined,no_issuetracker_defined'), $this);?>
...
"
      ...
      <tr>
        <td><?php echo $this->_tpl_vars['labels']['testproject_issue_tracker_integration']; ?>
</td><td></td>
      </tr>
      <?php if ($this->_tpl_vars['gui']->issueTrackers == ''): ?>
        <tr>
          <td></td>
          <td><?php echo $this->_tpl_vars['labels']['no_issuetracker_defined']; ?>
</td>
        </tr>
      <?php else: ?>
        <tr>
          ...
          <td>
            <input type="checkbox" id="issue_tracker_enabled"
                   name="issue_tracker_enabled" <?php if ($this->_tpl_vars['gui']->issue_tracker_enabled == 1): ?> checked="checked" <?php endif; ?> />
        ...
        <tr>
          <td></td>
          <td>
            <?php echo $this->_tpl_vars['labels']['issue_tracker']; ?>

             <select name="issue_tracker_id" id="issue_tracker_id">
             <option value="0">&nbsp;</option>
             <?php $_from = $this->_tpl_vars['gui']->issueTrackers; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['issue_tracker']):
?>
               <option value="<?php echo $this->_tpl_vars['issue_tracker']['id']; ?>
" 
                 <?php if ($this->_tpl_vars['issue_tracker']['id'] == $this->_tpl_vars['gui']->issue_tracker_id): ?> selected <?php endif; ?> 
               >
               <?php echo ((is_array($_tmp=$this->_tpl_vars['issue_tracker']['verbose'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</option>
             <?php endforeach; endif; unset($_from); ?>
             </select>
          </td>
