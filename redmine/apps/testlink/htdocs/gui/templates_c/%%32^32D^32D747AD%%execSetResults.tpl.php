...
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'execute/execSetResults.tpl', 19, false),array('function', 'config_load', 'execute/execSetResults.tpl', 43, false),array('function', 'cycle', 'execute/execSetResults.tpl', 411, false),array('function', 'html_options', 'execute/execSetResults.tpl', 424, false),array('modifier', 'basename', 'execute/execSetResults.tpl', 42, false),array('modifier', 'replace', 'execute/execSetResults.tpl', 42, false),array('modifier', 'escape', 'execute/execSetResults.tpl', 107, false),)), $this); ?>
...
<div id="main_content" class="workBack">
	<?php if ($this->_tpl_vars['gui']->user_feedback != ''): ?>
		<div class="error"><?php echo $this->_tpl_vars['gui']->user_feedback; ?>
</div>
	<?php endif; ?>
...
?>
      	  <?php if ($this->_tpl_vars['tc_exec']['active'] == 1): ?>	 
...
">
	        <?php echo $this->_tpl_vars['gui']->execStatusValues[$this->_tpl_vars['tc_exec']['status']]; ?>
	   			...
	   			<td>
	   			    ...
	   			    <select name="status[<?php echo $this->_tpl_vars['tcversion_id']; ?>
