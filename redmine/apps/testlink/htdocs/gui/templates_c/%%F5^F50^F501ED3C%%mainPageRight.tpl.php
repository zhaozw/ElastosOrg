...
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'mainPageRight.tpl', 8, false),array('modifier', 'escape', 'mainPageRight.tpl', 117, false),array('modifier', 'truncate', 'mainPageRight.tpl', 118, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['gui']->countPlans > 0 && ( $this->_tpl_vars['gui']->grants['testplan_execute'] == 'yes' || $this->_tpl_vars['gui']->grants['testplan_metrics'] == 'yes' )): ?>
