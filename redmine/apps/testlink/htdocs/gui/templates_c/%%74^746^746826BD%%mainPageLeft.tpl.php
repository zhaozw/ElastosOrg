<?php /* Smarty version 2.6.26, created on 2013-06-24 15:11:52
         compiled from mainPageLeft.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'mainPageLeft.tpl', 9, false),)), $this); ?>
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'title_product_mgmt,href_tproject_management,href_admin_modules,
                          ...
                          href_reqmgrsystem_management'), $this);?>
...
<?php if ($this->_tpl_vars['gui']->testprojectID && ( $this->_tpl_vars['gui']->grants['cfield_management'] == 'yes' || $this->_tpl_vars['gui']->grants['issuetracker_management'] || $this->_tpl_vars['gui']->grants['issuetracker_view'] )): ?>
   <?php $this->assign('display_left_block_2', true); ?>
    ...
    function display_left_block_2()
    {
        var p1 = new Ext.Panel({
                                title: '; ?>
'<?php echo $this->_tpl_vars['labels']['system_config']; ?>
'<?php echo ',
                                collapsible:false,
                                collapsed: false,
                                draggable: false,
...
" />
   ...
   <?php if ($this->_tpl_vars['gui']->grants['issuetracker_management'] || $this->_tpl_vars['gui']->grants['issuetracker_view']): ?>
      <br />
        <img src="<?php echo $this->_tpl_vars['tlImages']['bullet']; ?>
" />
      <a href="lib/issuetrackers/issueTrackerView.php"><?php echo $this->_tpl_vars['labels']['href_issuetracker_management']; ?>
</a>
    <?php endif; ?>
    </div>
  <?php endif; ?>
...
?feature=printTestSpec"><?php echo $this->_tpl_vars['labels']['href_print_tc']; ?>
        ...
        <img src="<?php echo $this->_tpl_vars['tlImages']['bullet']; ?>
" />
        <a href="lib/results/tcCreatedPerUserOnTestProject.php?do_action=uinput&tproject_id=<?php echo $this->_tpl_vars['gui']->testprojectID; ?>
"><?php echo $this->_tpl_vars['labels']['link_report_test_cases_created_per_user']; ?>
</a>
     <?php endif; ?>
