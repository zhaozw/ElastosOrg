<?php /* Smarty version 2.6.26, created on 2013-07-23 13:54:11
...
?>
    <span>
 	       <?php if ($this->_tpl_vars['menu']['directLink'] != ''): ?>
  	       <?php echo $this->_tpl_vars['menu']['toggle']; ?>
...
&amp;tplan_id=<?php echo $this->_tpl_vars['gui']->tplan_id; ?>
	       ...
	       target="workframe"><?php echo $this->_tpl_vars['menu']['name']; ?>
 	       ...
 	       <?php echo $this->_tpl_vars['menu']['directLinkDiv']; ?>
