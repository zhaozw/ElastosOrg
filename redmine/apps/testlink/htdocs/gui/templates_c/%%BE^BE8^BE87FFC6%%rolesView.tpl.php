<?php /* Smarty version 2.6.26, created on 2013-06-27 11:18:25
         compiled from usermanagement/rolesView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'usermanagement/rolesView.tpl', 15, false),array('function', 'config_load', 'usermanagement/rolesView.tpl', 21, false),array('modifier', 'replace', 'usermanagement/rolesView.tpl', 20, false),array('modifier', 'escape', 'usermanagement/rolesView.tpl', 50, false),array('modifier', 'strip_tags', 'usermanagement/rolesView.tpl', 94, false),array('modifier', 'strip', 'usermanagement/rolesView.tpl', 94, false),)), $this); ?>
...
<?php $this->assign('duplicateRoleAction', ($this->_tpl_vars['roleActionMgr'])."?doAction=duplicate&amp;roleid="); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => "btn_create,title_user_mgmt,title_roles,delete_role,caption_possible_affected_users,
             ...
             th_roles,th_role_description,th_delete,alt_edit_role,alt_delete_role,N_A,duplicate_role"), $this);?>
...
"><?php echo $this->_tpl_vars['labels']['th_role_description']; ?>
				...
				<th class="icon_cell"><?php echo $this->_tpl_vars['labels']['th_duplicate_role']; ?>
</th>
			</tr>
...
"/>
				...
				<td>
          <a href="<?php echo $this->_tpl_vars['duplicateRoleAction']; ?>
<?php echo $this->_tpl_vars['role']->dbID; ?>
">
          <img style="border:none;cursor: pointer;" title="<?php echo $this->_tpl_vars['labels']['duplicate_role']; ?>
" alt="<?php echo $this->_tpl_vars['labels']['duplicate_role']; ?>
"
               src="<?php echo $this->_tpl_vars['tlImages']['duplicate']; ?>
"/>
          </a>
				</td>
