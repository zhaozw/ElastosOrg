<?php /* Smarty version 2.6.26, created on 2013-06-24 15:11:37
         compiled from project/projectView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'project/projectView.tpl', 12, false),array('modifier', 'replace', 'project/projectView.tpl', 12, false),array('modifier', 'escape', 'project/projectView.tpl', 76, false),array('modifier', 'strip_tags', 'project/projectView.tpl', 84, false),array('modifier', 'strip', 'project/projectView.tpl', 84, false),array('modifier', 'truncate', 'project/projectView.tpl', 84, false),array('function', 'config_load', 'project/projectView.tpl', 13, false),array('function', 'lang_get', 'project/projectView.tpl', 21, false),)), $this); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'title_testproject_management,testproject_txt_empty_list,tcase_id_prefix,
          ...
          th_issuetracker,th_reqmgrsystem_short'), $this);?>
...
"/>
      ...
      <td width="10%">
        <?php echo $this->_tpl_vars['testproject']['itstatusImg']; ?>
 &nbsp; <?php echo ((is_array($_tmp=$this->_tpl_vars['testproject']['itname'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
