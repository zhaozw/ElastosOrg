...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'inc_head.tpl', 23, false),)), $this); ?>
...
";</style>
	...
	<?php if ($this->_tpl_vars['use_custom_css']): ?>
	<style media="all" type="text/css">@import "<?php echo $this->_tpl_vars['custom_css']; ?>
";</style>
	<?php endif; ?>
