<?php
	...
	{	
		...
		{
			$this->output('<div id="qa-login-bar"><div id="qa-login-group"><div style="float:left;padding-right:10px;"><a href="http://elastos.com/" title="elastos.com"><img src="/elorg_common/img/ElastosCom_Logo.png" style="width:25px;height:25px;"/></a><a href="http://elastos.org/" title="elastos.org"><img src="/elorg_common/img/ElastosOrg_RedLogo.png" style="width:25px;height:25px;"/></a></div>');
