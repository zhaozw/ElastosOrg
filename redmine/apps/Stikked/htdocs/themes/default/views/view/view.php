...
<?php } ?>
			...
			<?php }?>
			<span class="detail"><span class="item"><?php echo lang('paste_embed'); ?> </span><input data-lang-showcode="<?php echo lang('paste_showcode'); ?>" id="embed_field" type="text" value="<?php echo htmlspecialchars('<iframe src="' . st_site_url('view/embed/' . $pid . '/' . $seg3) . '" style="border:none;width:100%"></iframe>'); ?>" /></span>
			<div class="spacer"></div>
			
			<span class="detail">
<?php if($seg3 != 'diff'){ ?>
            <a class="control" href="<?php echo st_site_url("view/download/".$pid); ?>"><?php echo lang('paste_download'); ?></a> <?php echo lang('paste_or'); ?> <a class="control" href="<?php echo st_site_url("view/raw/".$pid); ?>"><?php echo lang('paste_viewraw'); ?></a>
<?php }else{ ?>
		...
		?>
			...
			?>
				...
				<tr class="<?php echo $eo; ?>">
					<td class="first"><a href="<?php echo st_site_url("view/".$reply['pid']); ?>"><?php echo $reply['title']; ?></a></td>
