...
<?php if(!$this->config->item('private_only')){ ?>
								<li><img class="pull-left" style="margin-top: 10px" src="<?php echo base_url(); ?>themes/geocities/images/new.gif"><a style="float: left; padding: 10px 15px 10px 5px;" <?php if($l == "lists" || $l == "view" and $this->uri->segment(2) != "options"){ echo 'class="active"'; }?> href="<?php echo st_site_url('lists'); ?>" title="<?php echo lang('menu_recent_title'); ?>"><?php echo lang('menu_recent'); ?></a></li>
								<li><img class="pull-left" style="margin-top: 7px" src="<?php echo base_url(); ?>themes/geocities/images/hot.gif"><a style="float: left; padding: 10px 15px 10px 5px;" <?php if($l == "trends"){ echo 'class="active"'; }?> href="<?php echo st_site_url('trends'); ?>" title="<?php echo lang('menu_trending_title'); ?>"><?php echo lang('menu_trending'); ?></a></li>
<?php } ?>
