...
<p>You must be <a href="../default/<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>">logged in</a> to post a comment.</p>
<?php else : ?>

<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform"><div class="formdata">
<div id="formtitle">Leave a Comment - Here's your chance to speak.<small>(eMail will not be published)</small></div>
<?php if ( $user_ID ) : ?>
...
<p><textarea name="comment" id="comment" cols="60%" rows="10" tabindex="4"></textarea>
</p>
