			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit" style="border-color: #298cba; color: #fff; background: #21759b repeat-x scroll left top;"><?php _e( 'Submit', 'bbpress' ); ?></button>
