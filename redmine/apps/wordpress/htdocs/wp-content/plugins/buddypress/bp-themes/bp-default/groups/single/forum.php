	...
	<?php if ( !bp_group_is_user_banned() && ( ( is_user_logged_in() && 'public' == bp_get_group_status() ) || bp_group_is_member() ) ) : ?>
		...
		<form action="" method="post" id="forum-topic-form" class="standard-form">
			<div id="new-topic-post">
				...
				<div class="submit">
					<input type="submit" name="submit_topic" id="submit" style="border-color: #298cba; color: #fff; background: #21759b repeat-x scroll left top;" value="<?php _e( 'Post Topic', 'buddypress' ); ?>" />
				</div>
