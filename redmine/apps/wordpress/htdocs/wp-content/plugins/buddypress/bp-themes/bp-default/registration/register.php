	...
	<div id="content">
		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div class="register-section" id="blog-details-section">
						...
						<div id="blog-details"<?php if ( true|| (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
							...
							<span class="label" style="display:none;"><?php _e( 'I would like my site to appear in search engines, and in public listings around this network.', 'buddypress' ); ?>:</span>
							<?php do_action( 'bp_signup_blog_privacy_errors' ); ?>

							<label style="display:none;"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_public" value="public"<?php if ( 'public' == bp_get_signup_blog_privacy_value() || !bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes', 'buddypress' ); ?></label>
							<label style="display:none;"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_private" value="private"<?php if ( 'private' == bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'No', 'buddypress' ); ?></label>
				...
				<div class="submit">
					<input type="submit" name="signup_submit" id="signup_submit" style="border-color: #298cba; color: #fff; background: #21759b repeat-x scroll left top;" value="<?php _e( 'Complete Sign Up', 'buddypress' ); ?>" />
				</div>
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<?php
					...
					$nonce = wp_create_nonce('ElastosOrg');
					echo '<p>If you have not received our email, press here: <a href="/wp-elastosorg.php?fun=usermail&user_name=' . $bp->signup->username . '&_wpnonce=' . $nonce . '" onclick="jQuery.get(this.href);return false;">Resend Activation Email' . '</a></p>';
				?>
