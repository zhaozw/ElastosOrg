		...
		<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
			...
			<div<?php bp_field_css_class( 'editfield' ); ?>>
				...
				<?php if ( 'textbox' == bp_get_the_profile_field_type() ) : ?>
					...
					<input type="text" name="<?php bp_the_profile_field_input_name(); bp_the_profile_readonly(); ?>" id="<?php bp_the_profile_field_input_name(); ?>" value="<?php bp_the_profile_field_edit_value(); ?>" <?php if ( bp_get_the_profile_field_is_required() ) : ?>aria-required="true"<?php endif; ?>/>
