...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<div id="whats-new-content" style="height:160px;">
		...
		<div id="whats-new-options" style="position:relative;top:-32px;">
			<div id="whats-new-submit">
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php _e( 'Post MicroBLOG', 'buddypress' ); ?>" style="font-weight:bold;background:#B7DBE9;color:red;border-width:2px;"/>
			</div>
