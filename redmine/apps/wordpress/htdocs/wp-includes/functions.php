...
function wm_make_clickable($content) {
    ...
    $str = preg_replace("/((https?:\/\/)(([a-zA-Z0-9_-]+((\.[a-zA-Z0-9_-]+)+)?\.([a-zA-Z]+))(\:[0-9]+)?)|((https?:\/\/)([0-1]?[0-9]?[0-9]|2[0-5][0-5])\.([0-1]?[0-9]?[0-9]|2[0-5][0-5])\.([0-1]?[0-9]?[0-9]|2[0-5][0-5])\.([0-1]?[0-9]?[0-9]|2[0-5][0-5]))(\:[0-9]+)?)(\/[\w-~.\/?;%&=\:#\[\]@\!\$'\(\)\*\+,]*)?/i", '<a href="\\0" rel="external nofollow">\\0</a>', $str);
