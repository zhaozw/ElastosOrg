...
var wx_token = "kortide";//process.env.WX_TOKEN || 'kortide';
var wx_token2 = process.env.WX_TOKEN_2 || 'elastos';
...
app.use(express.session({ secret: 'kortide', store: new express.session.MemoryStore() }));
