...
HTTPD_PIDFILE=/opt/redmine/apache2/logs/httpd.pid


HTTPD="/opt/redmine/apache2/bin/httpd -f /opt/redmine/apache2/conf/httpd.conf"
...
. /opt/redmine/apache2/bin/envvars
