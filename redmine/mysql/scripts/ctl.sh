...
HOSTNAME=`hostname`
MYSQL_PIDFILE=/opt/redmine/mysql/data/$HOSTNAME.pid

MYSQL_START="/opt/redmine/mysql/bin/mysqld_safe --defaults-file=/opt/redmine/mysql/my.cnf --port=3306 --socket=/opt/redmine/mysql/tmp/mysql.sock  --datadir=/opt/redmine/mysql/data --log-error=/opt/redmine/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
