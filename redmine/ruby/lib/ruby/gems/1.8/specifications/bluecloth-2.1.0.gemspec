...
Gem::Specification.new do |s|
  ...
  s.description = %q{BlueCloth is a Ruby implementation of John Gruber's [Markdown][markdown], a
...
'gem' directive:
  ...
  s.files = ["bin/bluecloth", "ext/extconf.rb"]
  ...
  s.summary = %q{BlueCloth is a Ruby implementation of John Gruber's [Markdown][markdown], a text-to-HTML conversion tool for web writers}
