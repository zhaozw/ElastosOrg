...
sub new {
    bless( {
        'API_VERSION' => 2,
        'APXS_APR_BINDIR' => '/bitnami/rubystack-linux-x64/output/apache2/bin',
        'APXS_APU_BINDIR' => '/bitnami/rubystack-linux-x64/output/apache2/bin',
        'APXS_BINDIR' => '/bitnami/rubystack-linux-x64/output/apache2/bin',
        'APXS_EXTRA_CFLAGS' => '-pthread',
        'APXS_EXTRA_CPPFLAGS' => '-DLINUX=2 -D_REENTRANT -D_GNU_SOURCE',
        'APXS_INCLUDEDIR' => '/bitnami/rubystack-linux-x64/output/apache2/include',
        'APXS_LIBEXECDIR' => '/bitnami/rubystack-linux-x64/output/apache2/modules',
        'APXS_NOTEST_CPPFLAGS' => '',
        'MODPERL_AP_INCLUDEDIR' => '/bitnami/rubystack-linux-x64/output/apache2/include',
        'MODPERL_AP_LIBEXECDIR' => '/bitnami/rubystack-linux-x64/output/apache2/modules',
        'MODPERL_AP_LIBS' => '',
        'MODPERL_AR' => 'ar',
        'MODPERL_ARCHLIBEXP' => '/opt/redmine/perl/lib/5.8.8/x86_64-linux',
        'MODPERL_CC' => 'cc',
        'MODPERL_CCCDLFLAGS' => '-fpic',
        'MODPERL_CCOPTS' => ' -fno-strict-aliasing -pipe -Wdeclaration-after-statement -I/usr/local/include -I/opt/redmine/perl/lib/5.8.8/x86_64-linux/CORE -DMOD_PERL -DMP_COMPAT_1X -DLINUX=2 -D_REENTRANT -D_GNU_SOURCE',
        'MODPERL_CP' => 'cp',
        'MODPERL_CPPRUN' => 'cc -E',
        ...
        'MODPERL_INC' => '-I/bitnami/rubystack-linux-x64/src/mod_perl-2.0.4/src/modules/perl -I/bitnami/rubystack-linux-x64/src/mod_perl-2.0.4/xs -I/bitnami/rubystack-linux-x64/output/apache2/include -I/bitnami/rubystack-linux-x64/output/apache2/include  -I/bitnami/rubystack-linux-x64/output/apache2/include',
        'MODPERL_LD' => 'cc',
        'MODPERL_LDDLFLAGS' => '-shared',
        'MODPERL_LDOPTS' => '-Wl,-E -Wl,-rpath,/opt/redmine/perl/lib/5.8.8/x86_64-linux/CORE  /opt/redmine/perl/lib/5.8.8/x86_64-linux/auto/DynaLoader/DynaLoader.a -L/opt/redmine/perl/lib/5.8.8/x86_64-linux/CORE -lperl -lnsl -ldl -lm -lcrypt -lutil -lc',
        'MODPERL_LIB' => 'mod_perl.so',
        'MODPERL_LIBNAME' => 'mod_perl',
        'MODPERL_LIBPERL' => '/opt/redmine/perl/lib/5.8.8/x86_64-linux/CORE/libperl.so',
        ...
        'MODPERL_PERLPATH' => '/opt/redmine/perl/bin/perl',
        'MODPERL_PRIVLIBEXP' => '/opt/redmine/perl/lib/5.8.8',
        'MODPERL_RANLIB' => ':',
        'MODPERL_RM' => 'rm',
        'MODPERL_RM_F' => 'rm -f',
        'MODPERL_TEST_F' => 'test -f',
        'MODPERL_XSUBPP' => '$(MODPERL_PERLPATH) $(MODPERL_PRIVLIBEXP)/ExtUtils/xsubpp -typemap $(MODPERL_PRIVLIBEXP)/ExtUtils/typemap -typemap /bitnami/rubystack-linux-x64/src/mod_perl-2.0.4/lib/typemap',
        'MP_APR_LIB' => 'aprext',
        'MP_APXS' => '/bitnami/rubystack-linux-x64/output/apache2/bin/apxs',
        'MP_COMPAT_1X' => 1,
        'MP_GENERATE_XS' => 1,
        'MP_LIBNAME' => 'mod_perl',
        'MP_USE_DSO' => 1,
        'VERSION' => '2.0.4',
        'XS' => {},
        'ap_includedir' => '/bitnami/rubystack-linux-x64/output/apache2/include',
        'apr_bindir' => '/bitnami/rubystack-linux-x64/output/apache2/bin',
        'apr_config' => {
                          'HAS_DSO' => '1',
                          'HAS_FORK' => '1',
                          'HAS_INLINE' => '1',
        ...
        'apr_config_path' => '/bitnami/rubystack-linux-x64/output/apache2/bin/apr-1-config',
        'apr_includedir' => '/bitnami/rubystack-linux-x64/output/apache2/include',
        'apu_config_path' => '/bitnami/rubystack-linux-x64/output/apache2/bin/apu-1-config',
        'cwd' => '/bitnami/rubystack-linux-x64/src/mod_perl-2.0.4',
        'dir' => undef,
        ...
        'httpd_version' => {
                             '/bitnami/rubystack-linux-x64/output/apache2/include' => '2.2.22'
                           }
      }, 'Apache2::Build' );
}
